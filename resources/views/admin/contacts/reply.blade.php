...
<div class="wrapper">
    <section class="content container-fluid">
        <form  action="{{route('admin/contacts.submitReplyContact',$reply->id)}}" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-lg-5">
                ...
                <a href="{{route('admin/contacts.index')}}" class="btn btn-danger">Hủy</a>
